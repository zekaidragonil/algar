...
<div class="max-w-3xl mt-20 mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <h2 class="text-2xl font-semibold mb-6 text-gray-800">Editar Especialidad</h2>
    ...
    <form action="{{ route('especialidades.update', $especialidad) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="nombre" name="nombre" value="{{ old('nombre', $especialidad->nombre) }}" required>
        </div>
