               ...
               <div class="p-6 text-gray-900">
                   <div class="container mx-auto px-4 py-8">
                       <div class="bg-white shadow-md rounded-lg p-6">
                        <a href="{{ route('asignacion.create') }}" class="inline-block mb-4 py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-500">Nueva Asignacion</a>
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center border-b">
                                        ...
                                        <td class="py-2 px-4">
                                            ...
                                            <a href="{{ route('asignacion.edit', $cita) }}"
                                                class="ml-4 text-indigo-600 hover:text-indigo-900">Editar</a>
                                           
                                            <form action="{{ route('asignacion.destroy', $cita) }}" method="POST" class="inline-block ml-4"
